...
function NavBar() {
  const navLinkClasses = ({ isActive }) =>
    `px-4 py-2 rounded-lg text-xm hover:bg-gray-700/70 
  ...
  return (
    ...
    px-4 md:px-2 py-2 bg-black/30 backdrop-blur-sm border border-gray-800/50 sticky top-0 z-30">
      {/* Logo and Brand */}
      ...
      <div className="flex items-center">
        <Link
          to="/auth"
          className="px-5 py-2.5 rounded-lg bg-green-400 text-xm text-white font-semibold 
